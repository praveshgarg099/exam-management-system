...
public class testmaker {
	...
	public void loadSchedules() {
		...
		try {
			...
			for (Subject sub : subjectService.getAllSubjects()) subjectMap.put(sub.getId(), sub);

			allSchedules = examService.getAllSchedules();
		...
		btnSubmit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					examService.scheduleExam(uName, subName, timeVal, quesVal, passVal);
		...
		saveBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					examService.updateExamSchedule(es.getId(), duration, questions, passing);
