...
public class resultpage {
	...
	public resultpage(exam_management_syatem.security.UserSession session) {
	...
	public void loadResults() {
		try {
			// Refresh cache
			for (Subject s : subjectService.getAllSubjects(session)) subjectMap.put(s.getId(), s);
			...
			currentResultsList = resultService.searchAndFilter(session, searchTxt, selSubject, selStatus);
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (confirm == JOptionPane.YES_OPTION) {
					try {
						...
						resultService.deleteResultById(session, resultId);
