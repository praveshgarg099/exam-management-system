		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					java.util.List<exam_management_syatem.model.Subject> subjects = subjectService.getActiveSubjects(adminpage1.getAdminSession());
	...
	private void initialize() {
		...
		btnNewButton_1_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					exam_management_syatem.service.SubjectService subjectService = new exam_management_syatem.service.SubjectService();
					exam_management_syatem.model.Subject subject = subjectService.getSubjectByName(adminpage1.getAdminSession(), p);
					if (subject == null) {
					...
					questionService.addQuestion(adminpage1.getAdminSession(), subject.getId(), question, option1, option2, option3, option4, answer, diff);
		...
		btnNewButton_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					exam_management_syatem.service.SubjectService subjectService = new exam_management_syatem.service.SubjectService();
					exam_management_syatem.model.Subject subject = subjectService.getSubjectByName(adminpage1.getAdminSession(), ss);
					if (subject != null) {
						exam_management_syatem.service.QuestionService questionService = new exam_management_syatem.service.QuestionService();
						int count = questionService.getQuestionCountBySubjectId(adminpage1.getAdminSession(), subject.getId());
