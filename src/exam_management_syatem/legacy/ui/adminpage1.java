...
public class adminpage1 {
	...
	private static exam_management_syatem.security.UserSession currentSession;

	public static exam_management_syatem.security.UserSession getAdminSession() {
		return currentSession;
	}

	public static void setAdminSession(exam_management_syatem.security.UserSession session) {
	...
	private void initialize() {
		...
		try {
			...
			exam_management_syatem.service.DashboardMetricsService.Metrics m = dms.getMetrics(getAdminSession());
