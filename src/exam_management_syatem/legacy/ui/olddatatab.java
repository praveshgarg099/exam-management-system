...
public class olddatatab {
	...
	public static void fgh() {
		...
		try {
			...
			exam_management_syatem.model.Subject subject = subjectService.getSubjectByName(adminpage1.getAdminSession(), s1);
			if (subject == null) return;

			exam_management_syatem.service.QuestionService questionService = new exam_management_syatem.service.QuestionService();
			java.util.List<exam_management_syatem.model.Question> questions = questionService.getQuestionsBySubjectId(adminpage1.getAdminSession(), subject.getId());
		...
		btnToggleActive.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					exam_management_syatem.service.QuestionService questionService = new exam_management_syatem.service.QuestionService();
					questionService.setQuestionActive(adminpage1.getAdminSession(), qId, !isCurrentlyActive);
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (confirm == JOptionPane.YES_OPTION) {
					try {
						...
						exam_management_syatem.service.QuestionService questionService = new exam_management_syatem.service.QuestionService();
						questionService.deleteQuestion(adminpage1.getAdminSession(), questionId);
