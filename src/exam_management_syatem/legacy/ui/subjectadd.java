...
public class subjectadd extends JFrame {
	...
	public subjectadd(exam_management_syatem.security.UserSession session) {
	...
	public void loadSubjects() {
		...
		try {
			allSubjects = subjectService.getAllSubjects(session);
	...
	private void initialize() {
		...
		btnAdd.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					subjectService.addSubject(session, s);
		...
		btnRename.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (newName != null && !newName.trim().isEmpty() && !newName.trim().equals(sub.getName())) {
					...
					try {
						subjectService.updateSubject(session, sub.getId(), newName.trim());
		...
		btnToggle.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					subjectService.setSubjectActive(session, sub.getId(), targetStatus);
